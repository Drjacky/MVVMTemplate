...
REPO_URL = 'https://github.com/Drjacky/MVVMTemplate'
ORIGINAL_PACKAGE_NAME = 'app.web.drjackycv'
...
def main():
    ...
    print(
        'Fetching the lastest source code archive from %s\nThis might take a couple minutes.' % green(
            REPO_URL))
