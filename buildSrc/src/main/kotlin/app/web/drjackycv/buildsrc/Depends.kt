...
object Depends {
    ...
    object Versions {
        ...
        const val gradleVersion = "4.2.1"//"7.1.0-alpha01"
        ...
        const val coilVersion = "0.11.1"
        const val autoDispose = "2.0.0"
        const val dataStorePreferenceVersion = "1.0.0-beta01"
        const val composeVersion = "1.0.0-beta08"
        const val composePagingVersion = "1.0.0-alpha10"
        const val composeNavigationVersion = "2.4.0-alpha02"
