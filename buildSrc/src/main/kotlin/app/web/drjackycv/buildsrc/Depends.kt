...
object Depends {
    ...
    object Versions {
        ...
        const val mockitoInlineVersion = "3.9.0"
        const val espressoVersion = "3.4.0-alpha06"
        const val junitVersion = "4.13.2"
        const val supportTestVersion = "1.4.0-alpha06"
        const val testCoreVersion = "1.4.0-alpha06"
        const val testExtJunitVersion = "1.1.3-alpha06"
